...
$featurearray = array("Age" => array("18","25","35","45","55","65","75"),"Gender" => array("Man","Woman","Non-binary","Transgender"),"Health" => array("In good health","Receiving radiotherapy for lung cancer","At risk of heart diseease"),"Surveillance attitude" => array("Believes big tech is manipulating us by collecting personal data","Convinced government spies on them","Not concerned about surveillance"),"Ethnicity" => array("White American","Black American","Asian American"));

$restrictionarray = array();

$probabilityarray = array("Age" => array(1/7,1/7,1/7,1/7,1/7,1/7,1/7),"Gender" => array(0.25,0.25,0.25,0.25),"Health" => array(0.5,0.1,0.4),"Surveillance attitude" => array(0.3333333333333333,0.3333333333333333,0.3333333333333333),"Ethnicity" => array(0.3333333333333333,0.3333333333333333,0.3333333333333333));
